...
slug: /documentation/credit-transfer/introduction-2
...
<p>
  ...
  <a href="/documentation/fi-server" className="t14sm-t16lg blue-link bold">This is example if link hovered</a>
</p>
